<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontUserList.aspx.cs" Inherits="Comment_frontList" %>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>评论id</td><td>被评酒店</td><td>评论内容</td><td>评论时间</td><td>操作</td></tr>
				    					<asp:Repeater ID="RpComment" runat="server">
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="commentDelete('<%#Eval("commentId")%>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										</ItemTemplate>
 										</asp:Repeater>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
            ...
            <div class="form-group">
            	<label for="hotelObj_commentId">被评酒店：</label>
                <asp:DropDownList ID="hotelObj" runat="server"  CssClass="form-control" placeholder="请选择被评酒店"></asp:DropDownList>
            </div>
            
			<div class="form-group">
				<label for="commentTime">评论时间:</label>
				<asp:TextBox ID="commentTime"  runat="server" CssClass="form-control" placeholder="请选择评论时间" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="comment_hotelObj_hotelId_edit" class="col-md-3 text-right">被评酒店:</label>
		  	 <div class="col-md-9">
			    <select id="comment_hotelObj_hotelId_edit" name="comment.hotelObj.hotelId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
			...
			if (comment) {
				...
				$.ajax({
					...
					success: function(hotels,response,status) { 
						$("#comment_hotelObj_hotelId_edit").empty();
						var html="";
		        		$(hotels).each(function(i,hotel){
		        			html += "<option value='" + hotel.hotelId + "'>" + hotel.hotelName + "</option>";
		        		});
		        		$("#comment_hotelObj_hotelId_edit").html(html);
		        		$("#comment_hotelObj_hotelId_edit").val(comment.hotelObjPri);
					}
				});
